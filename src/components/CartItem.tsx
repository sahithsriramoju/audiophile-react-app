...
export const CartItem = ({productId, quantity}:CartItemProps) => {
    ...
    return (
        ...
        <li key={productInfo?.id} className="mb-6">
            <div className="flex">
                <img src={productInfo?.imageUrl || ""} className="h-16 w-16 rounded-lg mr-5"></img>
                ...
                <div className="flex justify-between grow bg-grey-1 py-4 px-4 font-bold text-xs ">
                    <button className="cursor-pointer" data-action="minus" type="button" 
                    ...
                    <button className="cursor-pointer" data-action="add" type="button" 
